...
export class CampaignCodexBaseSheet extends JournalSheet {
  ...
  async getData() {
    ...
    data.sheetData.enrichedDescription = await TextEditor.enrichHTML(description, { async: true, secrets: this.document.isOwner });
    ...
    data.sheetData.enrichedNotes = await TextEditor.enrichHTML(notes, { async: true, secrets: this.document.isOwner });
